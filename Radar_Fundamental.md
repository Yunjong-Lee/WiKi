...
# 3.4. [푸리에 급수](https://ogu45.com/zbxe/school/74027)
  ...
  - 진폭 스펙트럼의 역할
    + 신호가 갖는 다양한 주파수 성분의 양(정현파 진폭)을 나타냄.
    + 진폭 스펙트럼은 저주파에서 고주파로 갈수록 값이 감소하는 특성을 가짐. 또, 파형의 시간적인 변화가 완만한 신호의 진폭은 스펙트럼의 감소가 급격히 일어나고, 반대의 경우 시간적으로 급격한 변화를 보이는 신호의 진폭 스펙트럼 감소는 완만하다.
      ...
      > - 반면에, 불연속점을 갖는 사각 펄스와 같이 급격한 변화를 포함하는 신호는 이를 구현하기 위해 많은 주파수 성분이 필요할 뿐 아니라 고주파 성분의 크기도 상대적으로 무시할 수 없는 값을 갖는다. 따라서 진폭 스펙트름은 주파수에 따라서 느리게 감쇠할 것이고, 신호를 근사적으로 합성할 때 오차를 작게 하려면 많은 수의 푸리에 급수 항이 필요하다.
